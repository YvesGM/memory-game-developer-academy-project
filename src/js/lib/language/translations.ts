...
import type { Translations } from "./language-interfaces";

// ------------ CONSTANTS ------------//

/**
 * Contains all application translations grouped by supported language.
 *
 * Each language entry must implement the complete {@link Translations}
 * structure to ensure that all required interface texts are available.
 */
