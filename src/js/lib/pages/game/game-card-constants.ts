...
/**
 * Base path for the coding-theme card-front assets.
 */
export const CODING_CARD_PATH = "/game/coding/cards/";

/**
 * Base path for the gaming-theme card-front assets.
 */
export const GAMING_CARD_PATH = "/game/games/cards/";

/**
 * Base path for the academy-theme card-front assets.
 */
export const ACADEMY_CARD_PATH = "/game/da-projects/cards/";

/**
 * Base path for the food-theme card-front assets.
 */
export const FOOD_CARD_PATH = "/game/food/cards/";

/**
 * Maps every available game theme to its card and exit-button assets.
 */
export const THEME_CARD_ASSETS: Record<GameTheme, ThemeCardAssets> = {
  code: {
    ...
    cardFrontPaths: [
      `${CODING_CARD_PATH}angular-card.svg`,
